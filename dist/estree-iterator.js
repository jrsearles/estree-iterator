...
var _estreeKeys2 = _interopRequireDefault(_estreeKeys);
...
function defaultVisitor(node, state, w) {
	...
	return regeneratorRuntime.wrap(function defaultVisitor$(_context3) {
		while (1) switch (_context3.prev = _context3.next) {
			...
			case 2:
				if (!(node.type in _estreeKeys2.default)) {
					_context3.next = 11;
					break;
				}

				_i = 0, _ln = _estreeKeys2.default[node.type].length;
			...
			case 4:
				...
				_key = _estreeKeys2.default[node.type][_i];
...
var defaultVisitors = {};
Object.keys(_estreeKeys2.default).forEach(function (key) {
...
var EstreeIterator = (function () {
	...
	_createClass(EstreeIterator, [{
		...
		value: function extend(node, visitors, state) {
			var merged = Object.assign({}, _estreeKeys2.default, visitors);
...
exports.default = EstreeIterator;
;

},{"./estree-keys":191,"./traversal-context":193,"babel-polyfill":2}],193:[function(require,module,exports){
"use strict";
...
TraversalContext.prototype.getDirectives = function () {
	...
	if (this.isFunction() || this.isProgram()) {
		var i = 0;
		var length = this.node.body.length;

		while (i < length) {
			var current = this.node.body[i++];
